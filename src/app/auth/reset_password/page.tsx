        ...
        {step === 1 && (
          <form onSubmit={emailForm.handleSubmit}>
            <div className="mb-4">
              <FormField label="Email">
                ...
                {emailForm.touched.email && emailForm.errors.email && (
                  <div className="err-msg">{emailForm.errors.email}</div>
                )}
              </FormField>
            </div>
            ...
            <div className="flex justify-center gap-6 mb-4">
              <button
                type="button"
                className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-2xl border border-gray-600 p-2.5 hover:border-gray-400 transition-colors"
              >
              ...
              <button
                type="button"
                className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-2xl border border-gray-600 text-white p-2.5 hover:border-gray-400 transition-colors"
              >
                <svg
                  viewBox="0 0 384 512"
                  fill="currentColor"
