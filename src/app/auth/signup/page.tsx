    ...
    <div className="min-h-screen w-full flex items-center justify-center bg-black relative">
      ...
      >
        <div className="bg-[#00b46e] py-6 text-center">
          ...
          <p className="text-sm text-white opacity-80 mt-1">Let's create your account.</p>
        </div>
        ...
        <form onSubmit={handleSubmit} className="px-8 py-6">
          ...
          <p className="text-xs text-white mb-4">
            By signing up you agree to our <u>Terms</u>, <u>Privacy Policy</u>, and <u>Cookie Use</u>
          </p>
          
          <button type="submit" className="w-full py-3 rounded-lg bg-[#b6ffe4] text-black font-semibold mb-4 hover:bg-[#9effd6] transition-colors">
            Create an Account
          </button>

          <p className="text-center text-sm text-white mb-2">
           Already have an account? <span className="text-green-400 cursor-pointer"><a href="/auth/login">Login</a></span>
          </p>

          <p className="text-center text-gray-400 mb-3">OR</p>

          <div className="flex justify-center gap-6 mb-4">
            <button type="button" className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-2xl cursor-pointer border border-gray-600 hover:border-gray-400 transition-colors p-2.5">
            ...
            <button type="button" className="w-12 h-12 bg-black rounded-full flex items-center justify-center text-2xl cursor-pointer border border-gray-600 text-white hover:border-gray-400 transition-colors p-2.5">
