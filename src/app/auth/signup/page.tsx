...
export default function LoginPage() {
  ...
  return (
    <div className="min-h-screen w-full flex items-center justify-center bg-black relative">
      ...
      <div className="w-[420px] rounded-2xl shadow-xl bg-[#2d2a2a] border border-[#2d2a2a] overflow-hidden" style={{ boxShadow: "0 0 40px #00ff88" }}>
        ...
        <div className="px-8 py-6">
          <label className="block text-white text-sm mb-1">Fill Name</label>
          <input
            type="text"
